...
> **NOT SUBMISSION-READY / SUPERSEDED:** The official deadline is **September 9, 2026 at 2:00 PM PDT / 23:00 SAST**, not September 7. The weighting and multiple implementation/insurance claims below are also unsupported. Use [`winning/02-rubric-compliance-and-evidence.md`](../winning/02-rubric-compliance-and-evidence.md) and [`winning/05-demo-and-submission-playbook.md`](../winning/05-demo-and-submission-playbook.md).
