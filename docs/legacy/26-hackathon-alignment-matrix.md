...
> **SUPERSEDED:** This file's 40/30/30 weighting and three-criterion model are incorrect. Use [`winning/02-rubric-compliance-and-evidence.md`](../winning/02-rubric-compliance-and-evidence.md): the official rules list four equally weighted criteria, with tie-break priority in listed order.
