...
> [!IMPORTANT]
> **Quarantined concept blueprint:** [Winning Blueprint](winning/README.md) records intended corrections: deadline **September 9, 2026 at 2:00 PM PDT / 23:00 SAST**, four equally weighted criteria, a clearance-change-control wedge, and removal of unsupported claims. Because it was produced with Codex, it must not serve as the contest project plan or submission source. Independently reconstruct decisions and artifacts through the organizer-approved path.
...
This is being built first as a submission to **Agentic Cinema: The Blockbuster Hackathon** (Google Cloud + partner ecosystem, deadline September 9, 2026, 2:00 PM PDT), on the **Parallel** track, with the explicit intent to use hackathon placement as a pre-seed forcing function for a real company — not as a one-off competition entry that gets abandoned the day after judging.

## Documents in this package, and what each one is actually for

### Quarantined internal concept blueprint

The stack audit in [Winning Blueprint 09](../winning/09-tech-stack-audit-and-target-architecture.md) is the controlling internal assessment of the current repository's executable readiness and intended target stack. It does not make the scaffold submission-ready and must be independently reconstructed through the approved-tool process.

| Doc | Purpose |
|---|---|
| [Winning Blueprint](../winning/README.md) | Strategy index and definition of a credible first-place attempt |
| [First-Place Positioning](../winning/01-first-place-positioning.md) | Category, problem, buyer, differentiating loop, and success metrics |
| [Rubric, Compliance, and Evidence](../winning/02-rubric-compliance-and-evidence.md) | Official requirements, scorecard, pass/fail gates, remediation, and evidence room |
| [Product and Architecture](../winning/03-product-and-architecture.md) | Scope, data model, dependency graph, agents, runtime, APIs, trust, and tests |
| [Comprehensive Build Roadmap](../winning/04-build-roadmap.md) | Phases, sprints, dates, ownership, release gates, risks, and contingencies |
| [Demo and Submission Playbook](../winning/05-demo-and-submission-playbook.md) | Three-minute script, pitch, Q&A, recording, and Devpost checklists |
| [Competition, Claims, and Sources](../winning/06-competition-claims-and-sources.md) | Competitors, claim controls, sources, pre-mortem, and honest idea rating |
| [Evaluation and Traceability](../winning/07-evaluation-and-traceability.md) | Golden corpus, metrics, test-to-claim mapping, release readiness, and red-team gate |
| [Approved-Tool Reconstruction](../winning/08-approved-tool-reconstruction-handoff.md) | Provenance inventory, reconstruction order, checkpoints, and final handoff |
| [Technical Stack Audit](../winning/09-tech-stack-audit-and-target-architecture.md) | Current repository audit, exact target stack, integration decisions, migration map, security posture, and dated cutover gates |
...
| 28 | [Devpost Submission Manifest](28-devpost-submission-manifest.md) | Legacy Devpost submission & track manifest | Superseded September 7 assumptions and claims that require reconciliation |
| 29 | [Monetization & GTM Strategy](29-monetization-and-gtm.md) | Business model, SaaS pricing tiers, and partnership roadmap | Transactional audits, enterprise studio subscriptions, and E&O broker strategy |
| 30 | [UI Component Design System](30-ui-design-system.md) | Design tokens, glassmorphism UI components, and layout standards | Obsidian black dark theme, Inter/Outfit fonts, and micro-animation specs |
...
The numbered legacy package contains superseded strategy, dates, feature claims, and implementation assumptions. The `winning/` package identifies intended corrections but is not itself an eligible plan. Independently reconcile or remove all affected material during the approved-tool reconstruction.
