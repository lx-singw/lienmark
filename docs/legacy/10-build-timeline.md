...
> **SUPERSEDED:** The current date-specific, first-place execution plan is [`winning/04-build-roadmap.md`](../winning/04-build-roadmap.md). This legacy timeline uses an obsolete deadline and broader scope.
