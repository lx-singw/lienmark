...
- **FCP XML / DaVinci EDL Timeline Conformer**: Parses industry-standard Final Cut Pro XML, DaVinci Resolve EDL, and Avid AAF edit decision lists (`timeline_conformer.py`), extracting clip names, reel IDs, and exact timecodes (`edl_timecode_in` / `out`) to link rights claims directly to specific video frames.
